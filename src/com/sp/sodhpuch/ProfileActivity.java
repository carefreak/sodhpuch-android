...
public class ProfileActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// TextView profile_link = (TextView) findViewById(R.id.profile_link);
		// LinearLayout phone_container = (LinearLayout)
		...
		Linkify.addLinks(profile_phone, Linkify.ALL);
	...
	public void onClick(View v) {
		...
		// }
		else if (v.getId() == R.id.profile_link) {
			Log.d("contact", name);
		}
